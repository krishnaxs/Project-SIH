...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-stone-50 px-4 py-10">
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-slate-200/80 bg-white/95 p-8 shadow-xl backdrop-blur-sm">
