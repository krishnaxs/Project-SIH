...
print("RANDOM FOREST TIME SERIES VALIDATION")
print("-------------------------------------")
...
for _, actual_row in test_data.iterrows():
    ...
    # Add future date with unknown price
    future_row = pd.DataFrame([{
        "date": forecast_date,
        "modalPrice": np.nan,

        # We use actual arrivals here.
        # Price validation focuses on price recursion.
...
results_df.to_csv(
    "ai/data/random_forest_validation_results.csv",
    index=False
)


print("\nResults saved to:")
print("ai/data/random_forest_validation_results.csv")